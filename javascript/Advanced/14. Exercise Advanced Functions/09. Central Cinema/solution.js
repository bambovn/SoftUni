function solve() {
    ...
    function addMovieToScreen(e) {
        ...
        function archiveMovie(e) {
            ...
            let listInputValue = listMovieDivElement.querySelector('input[placeholder="Tickets Sold"]').value
    ...
    function clearEntireArchive(e) {
        ...
        archives.forEach(e => {sectionArchive.removeChild(e)})
    }


    function inputValidator() {
        let inputElements = Array.from(this.children).filter(e => e.nodeName === 'INPUT')
